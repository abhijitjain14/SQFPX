...
def mp = [('TestCaseID') : TestCaseID, ('Search') : Search, ('BudgetedUnbug') : BudgetedUnbug, ('ExpectedStartDate') : ExpectedStartDate
    ...
    , ('Status1') : Status1, ('Status2') : Status2, ('Status3') : Status3, ('TechnicalManager') : TechnicalManager
]
...
WebUI.callTestCase(findTestCase('TCmyExperts/TC02_Request_Approve'), [('TestCaseID') : TestCaseID, ('Run') : Run, ('BudgetedUnbug') : BudgetedUnbug
	, ('ExpectedStartDate') : ExpectedStartDate, ('ExpectedEndDate') : ExpectedEndDate, ('SRTitle') : SRTitle, ('Descriptiontext') : Descriptiontext, ('Country') : Country
	, ('Region') : Region, ('ApproverName') : ApproverName, ('Search') : Search, ('ExpectedStartMonth') : ExpectedStartMonth, ('ExpectedEndMonth') : ExpectedEndMonth
	, ('Status1') : Status1, ('Status2') : Status2], FailureHandling.STOP_ON_FAILURE)
