...
def mp = [('TestCaseID') : TestCaseID, ('Search') : Search, ('BudgetedUnbug') : BudgetedUnbug, ('ExpectedStartDate') : ExpectedStartDate
    ...
    , ('Status1') : Status1, ('Status2') : Status2, ('Status3') : Status3, ('Status4') : Status4, ('Status5') : Status5, ('Status6') :Status6 , ('Status7') :Status7 , ('TechnicalManager') : TechnicalManager
...
'Verify Status- Pending MoM Modification'
WebUI.callTestCase(findTestCase('null'), [('Status') : mp['Status7']], FailureHandling.CONTINUE_ON_FAILURE)
